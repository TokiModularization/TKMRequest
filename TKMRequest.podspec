...
Pod::Spec.new do |s|
  s.name             = 'TKMRequest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKMRequest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhengxianda0512@gmail.com/TKMRequest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhengxianda0512@gmail.com' => 'xianda.zheng@email.com' }
  s.source           = { :git => 'https://github.com/zhengxianda0512@gmail.com/TKMRequest.git', :tag => s.version.to_s }
